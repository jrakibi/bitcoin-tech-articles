...
The first transaction in Bitcoin history was a P2PK transaction from [block 170](https://mempool.space/tx/f4184fc596403b9d638783cf57adfe4c75c605f6356fbc91338530e9831e9e16) where _Satoshi Nakamoto_ sent 10 BTC to _Hal Finney_.

We will use this transaction to help us understand how P2PK works in detail. From the creation of the transaction to its validation. (Understanding P2PK will serves as an ideal foundation for understanding more complex scripts)
...
To see this in action, click on the **Output 1** of this transaction to view the scriptPubKey that Satoshi created to lock this 10 BTC to Hal's public key.
...
This signature proves that Hal has the private key corresponding to the public key specified in the ScriptPubKey.
...
Click on **Input 1** of this transaction to see this scriptSig created by Hal Finney
